...
<div style="float:right; margin-top:15px; margin-right:656px;">
    <p style="margin-bottom:5px;">총 <?php echo $number; ?>번 방문</p>
    <table>
        <tr class="title">
            <td>번호</td>
            <td>이름</td>
        ...
        $sql = "SELECT a.email, a.nickname, IFNULL( b.cnt, 0 ) AS cnt
				FROM (
				...
				LEFT JOIN (
				SELECT u.email, COUNT( v.visit_date ) AS cnt
    ...
    if($page <= 1){
    ?>
    <a href="today_visit.php?page=1">이전</a>
    <?php } else{ ?>
    <a href="today_visit.php?page=<?php echo ($page-1); ?>">이전</a>
    <?php };?>
    ...
    ?>
    <a href="today_visit.php?page=<?php echo $print_page; ?>"><?php echo $print_page; ?></a>
    <?php };?>
    ...
    if($page >= $total_page){
    ?>
    <a href="today_visit.php?page=<?php echo $total_page; ?>">다음</a>
    <?php } else{ ?>
    <a href="today_visit.php?page=<?php echo ($page+1); ?>">다음</a>
    <?php };?>
