...
<head>
    ...
    <title>WaterReminder 관리자 정보 수정</title>
	<style>
    ...
    <script type="text/javascript">
        function edit_check(idx){
            ...
            frm.action="edit_ok.php?u_idx="+idx;
        };
...
<div style="margin-top:15px;">
    <form name="edit_form" action="edit_ok.php" method="post" onsubmit="return edit_check(<?php echo $u_idx; ?>)">
        <fieldset>
            ...
            <p class="btn_wrap" style="margin-top: 20px;">
                ...
                <button type="button" class="btn" onclick="del_check(<?php echo $u_idx; ?>)">관리자삭제</button>
